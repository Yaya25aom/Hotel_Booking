  ...
  return (
    ...
    <img
      ...
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-5xl font-bold text-center text-gray-800 mb-8 mg-top-100"  style={{ paddingTop: '3rem'}}>Facilities & Wellness</div>
        <div className="text-center text-sm mb-8" style={{paddingTop: '2rem', paddingRight: '20rem', paddingBottom: '5rem', paddingLeft: '20rem' }}>
    CASA Facilities & Wellness offers guests a well-rounded luxury stay. There are all kinds of experiences to indulge here, from our swimming pools with a view, to our fitness facilities and a beach pavilion for a soothing body treatment. There's something for all parts of the day.
      ...
      <div className="grid grid-cols-2 gap-8 mb-8" style={{paddingRight: '4rem',paddingLeft: '4rem' }}>
        <div>
          ...
          <h2 className="text-3xl font-bold mt-4">Swimming Pools</h2>
          <p className="text-sm mt-2">
          Swimming Pool
Soak up the fresh air and sun in our spacious swimming pool. A true CASA highlight, the panoramic Olympic-sized swimming pool extends right to the oceanfront. Dip your toes onto the all marble tile floor, or simply float your day away.
          </p>
        </div>
        <div>
          <img src="/assets/image/kitchen3.jpg" alt="Kitchen & Bar" className="w-full h-96 object-cover rounded-lg" />
          <h2 className="text-3xl font-bold mt-4">Kitchen</h2>
          <p className="text-sm mt-2">
        ...
        <div>
          ...
          <h2 className="text-3xl font-bold mt-4">SELA Sea Sanctuary Spa</h2>
          <p className="text-sm mt-2">
        ...
        <div>
          ...
          <h2 className="text-3xl font-bold mt-4">Fitness</h2>
          <p className="text-sm mt-2">
