...
const List = () => {
  const [selectedRateOption, setSelectedRateOption] =
    useState("limited-time-offer");
    ...
    try {
      ...
      setRoomTypes(
        response.data.filter(
          (room: { Status: boolean }) => room.Status === true
        )
      );
    } catch (error) {
  ...
  const handleSelect = (ranges: RangeKeyDict | null | undefined) => {
        ...
        >
          ...
          <div className="flex">
            <div className="w-1/2 p-4 relative">
              <Link href={`/room/${room.RoomNo}`} passHref>
                <div>
                  <img
                    src={
                      roomData.find((data) => data.id === room.RoomNo)?.image ||
                      ""
                    }
            ...
            <div
              ...
              style={{ backgroundColor: "rgb(223 229 236)" }}
            >
                ...
                <div className="mr-4">
                  ...
                  >
                    <path
                      ...
                      strokeLinejoin="round"
                      strokeWidth={2}
                      d="M3 7v11m0-11l4 4m0 0l4-4m-4 4v11"
                    />
                  </svg>
              ...
              <p className="mb-4">
                The Ocean View Pool Junior Suites are situated on the highest
                level of the resort, offering cool breezes, total privacy and
                panoramic ocean views overlooking It has a private entrance
                walkway leading to the 70 squar...
              </p>
              <a
                href="#"
              ...
              <div className="flex items-center mb-4">
                <div className="flex items-center mr-4">
                  ...
                  />
                  <label
                    htmlFor={`limited-time-offer-${room.RoomNo}`}
                    className="ml-2"
                  >
                    Limited Time Offer With Wellbeing Credits
                  </label>
                  <span className="font-semibold">
                    THB {room.RoomType.RoomPrice}
                  </span>
                </div>
                <div className="flex items-center mb-4">
                  <input
                  ...
                  />
                  <label
                    htmlFor={`best-flexible-${room.RoomNo}`}
                    className="ml-2"
                  >
                    Best Flexible With Wellbeing Credits
                  </label>{" "}
                  {/* แก้ label เป็นปกติ */}
                  <span className="font-semibold">
                    THB {room.RoomType.DefalutRoomPrice}
                  </span>
                </div>
              </div>
          ...
          {isOpen === room.RoomNo && (
            <div
              className=" flex-grow bg-gray-100 rounded-lg p-8 items-center jutify-content "
              style={{ paddingLeft: "10rem", paddingRight: "32rem" }}
            >
                ...
                <div className="flex items-center mt-2">
                  <div className="mr-4 flex items-center">
                    ...
                    <span className="text-gray-600">
                      {room.RoomType?.RoomType_guest} People
                    </span>
                  </div>
                  <div className="mr-4 flex items-center">
                    <svg
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="text-gray-600">
                      {room.RoomType?.RoomType_size}
                    </span>
                  </div>
                </div>
              </div>
              <span className="text-gray-600 text-center jutify-content">
                {room.RoomType?.RoomTypeDescrip}
              </span>
              <div
                className="border border-black p-4 font-sans"
                style={{
                  width: "40%",
                  marginLeft: "820px",
                  marginTop: "-180px",
              ...
              >
                <h3 className="bg-red-600 text-white py-2 px-4 mb-4">
                  Limited Time Offer
                </h3>
                <div>
                  ...
                  <p className="mb-1">
                    THB{" "}
                    {selectedRateOption === "limited-time-offer"
                      ? room.RoomType.RoomPrice
                      : room.RoomType.DefalutRoomPrice}{" "}
                    x 1 Night{" "}
              ...
              <div className="flex gap-16 mb-2 py-8">
                <img
                  src="/assets/image/lob.jpeg"
                  style={{ width: "40%" }}
                ></img>
                <img
                  src="/assets/image/bbq.jpeg"
                  style={{ width: "40%" }}
                ></img>
              </div>
              ...
              <div className="flex gap-16 py-3 mb-3">
                <img
                  src="/assets/image/roman.webp"
                  style={{ width: "40%" }}
                ></img>
                <img
                  src="/assets/image/treat.jpeg"
                  style={{ width: "40%" }}
                ></img>
              </div>
              <div className="flex" style={{ gap: "13em" }}>
